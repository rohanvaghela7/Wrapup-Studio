  ...
  return <Shell><main className="about-page our-story-page">
    ...
    <section className="section story-origin-section">
      <div className="story-grid">
        <Reveal><ImageFrame src={portfolio[4].src} alt="A member of the Wrap UP creative team" label="The Wrap UP team · Mumbai" /></Reveal>
    ...
    <section className="story-team-section section-dark">
      <Reveal className="story-team-image"><ImageFrame src={portfolio[8].src} alt="Wrap UP team working on location" label="On location · Worldwide" /></Reveal>
